...
Then a series of experiment was performed with different edge sizes and the accuracy matrices were measured. Following are the some of the results.  
...
\section{Auto sketch creation with Edge Queries}
